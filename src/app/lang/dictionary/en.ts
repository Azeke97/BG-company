export default defineI18nLocale(() => {
  return {
    ...
    shop: {
      ...
      resultsCount: "Products found: {count}",
      emptyTitle: "No products found",
      emptySubtitle: "Try another category or remove part of the filters.",
      stockIn: "In stock: {count}",
      stockOut: "Out of stock",
      ctaConsult: "Request details",
      cart: {
        title: "Cart",
        add: "Add to cart",
        added: "Product added to cart",
        stockUnavailable: "This product is unavailable right now",
        ...
        form: {
          ...
          commentPlaceholder: "Additional order details",
          submit: "Place order",
        ...
        promo: {
          ...
          validation: "Enter promo code",
          applied: "Promo {code} applied (-{discount} ₸)",
          error: "Failed to apply promo code",
        },
      },
      seo: {
        catalogTitle: "Renovation Products Shop | BG Company",
        catalogDescription:
          "Browse BG Company renovation products: ceilings, furniture and related materials with practical filters and current prices.",
